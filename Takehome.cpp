...
int main()
{
	...
	for(int count =1; count != 0 ; n++  )	
	{
        ...
        printf("Please input Only 1-6 or 0 to Next\n");
    	}
	if(i==0)
		{
		count = 0;
	...
	if(state == 1)
	{
    printf("Coupon: 1.Fixed amount 2.Percentage discount 0.Next\n");
    printf("Coupon: ");
	while (true) {
        fgets(inputString, sizeof(inputString), stdin);
	...
	if(state == 2)	
	{
	printf("On Top: 1.Percentage discount of Category 2.Discount by point 0.Next\n");
	printf("On Top: ");
	while (true) {
        fgets(inputString, sizeof(inputString), stdin);
        if (sscanf(inputString, "%d", &p) == 1) {
	...
	{	
		...
		if(state == 3)	
	{
	printf("Seasonal: 1.Special campaigns 0.Next\n");
	printf("Seasonal: ");
	while (true) {
        fgets(inputString, sizeof(inputString), stdin);
        if (sscanf(inputString, "%d", &p) == 1) {
